...
function animate() {
    particlesGroup.rotation.x += 0.002;
    particlesGroup.rotation.y += 0.002;
    particlesGroup.rotation.z += 0.002;
    ...
    readCsvFile('assets/event000000000-truth.csv', function (dataTruth) {
        readCsvFile('assets/event000000000-hits.csv', function (dataHits) {
            ...
            for (var i = 0; i < allParticles.length; i++) {
                ...
                var curve = new(Function.prototype.bind.apply(THREE.CubicBezierCurve3, [null].concat(vectorArr)));
                ...
                particlesGroup.add(curveObject);
            }
...
//  Dictionary with array object for each row
